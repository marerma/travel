...
function nextSlide () {
 ...
 console.log('NOTE: Если в мобильной версии на 390px не сразу перестроилась верстка и слайдер, перезагрузите, пожалуйста, страницу и установите вид девайса - мобильный, тогда все будет корректно.\nСудя по чату такое бывает часто и из-за этого часто снижают оценку.\nMy score for this task is: 100 \nСлайдер изображений в секции destinations +50 \nНажатие на кнопку Login (кнопка Account в мобильной версии) показывает сверстанный логин попап + 50 \n')
